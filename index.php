                        ...
                        <div class="container">
                            <div class="banner-two__content">
                                ...
                                <div class="btn-wrp mt-65">
                                    <a href="shop.php" class="btn-one" data-animation="fadeInUp"
                            ...
                            <div class="banner-two__content">
                                ...
                                <div class="btn-wrp mt-65">
                                    <a href="shop.php" class="btn-one" data-animation="fadeInUp"
                                        data-delay="1.8s"><span>Shop
                                            Now</span></a>
                                    <a class="btn-one-light ml-20" href="shop-single.php" data-animation="fadeInUp"
                    ...
                    <div class="col-lg-6 wow fadeInLeft" data-wow-delay=".1s">
                        <div class="view__left-item">
                            ...
                            <div class="view__left-content sub-bg">
                                <h2><a class="primary-hover" href="shop-single.php">The best e-liqued bundles</a>
                                </h2>
                                <p class="fw-600">Sell globally in minutes with localized currencies languages, and
                                    experie
                                    in every market. only a variety of vaping
                                    products</p>
                                <a class="btn-two" href="shop-single.php"><span>Shop Now</span></a>
                    ...
                    <div class="col-lg-6">
                        <div class="view__item mb-25 wow fadeInDown" data-wow-delay=".2s">
                            <div class="view__content">
                                <h3><a class="primary-hover" href="shop-single.php">new to vapeing?</a></h3>
                        ...
                        <div class="view__item wow fadeInUp" data-wow-delay=".3s">
                            <div class="view__content">
                                <h3><a class="primary-hover" href="shop-single.php">Vap mode</a></h3>
                                <p>Whereas recognition of the inherent dignity</p>
                                <a class="btn-two" href="shop-single.php"><span>Shop Now</span></a>
                            </div>
                            <div class="view__image">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            ...
                            <div class="gallery__content">
                                <h3 class="mb-10"><a href="shop-2.php">best e-lequid</a></h3>
                                <p>Best E liquids from our huge collection</p>
                                <a href="shop-2.php" class="btn-two mt-25"><span>Shop Now</span></a>
                            </div>
                        </div>
                    </div>
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            ...
                            <div class="gallery__content">
                                <h3 class="mb-10"><a href="shop-2.php">best vape flavours</a></h3>
                                <p>Best E liquids from our huge collection</p>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            ...
                            <div class="gallery__content">
                                <h3 class="mb-10"><a href="shop-2.php">Battery And Charger Kit</a></h3>
                                <p>Best E liquids from our huge collection</p>
                                <a href="shop-2.php" class="btn-two mt-25"><span>Shop Now</span></a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            ...
                            <div class="gallery__content">
                                <h3 class="mb-10"><a href="shop-2.php">best vape tanks</a></h3>
                                <p>Best E liquids from our huge collection</p>
                                <a href="shop-2.php" class="btn-two mt-25"><span>Shop Now</span></a>
                            </div>
                        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="gallery__item">
                            ...
                            <div class="gallery__content">
                                <h3 class="mb-10"><a href="shop-2.php">POP Extra Strawberry</a></h3>
                                <p>Best E liquids from our huge collection</p>
                                <a href="shop-2.php" class="btn-two mt-25"><span>Shop Now</span></a>
                            </div>
                        </div>
