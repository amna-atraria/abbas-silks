                    ...
                    <div class="row g-4">
                                ...
                                <div class="swiper shop-single-slide">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <img src="assets/images/shop/sari2.jpg" alt="image">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="assets/images/shop/sari3.jpg" alt="image">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="assets/images/shop/sari4.jpg" alt="image">
                                        </div>
                                        <div class="swiper-slide">
                                            <img src="assets/images/shop/sari1.jpg" alt="image">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-7">
                            <div class="content h24">
                                <h3 class="pb-2 primary-color">SAREE</h3>
                                ...
                                <p class="text-justify mb-10">BANARSI HAND LOOM MADE PREMIUM SHAFOON SAREE ساڑی 
                                     6.5 yards saree 
                                    1 yard blouse 
                                     </p>
